...
print("The sum of the loans is", sum_of_loans)
...
print("The amount of months remaining is", remaining_months)
...
print("The price of the loan is", loan_price)
...
present_value = calculate_present_value(
    remaining_months = new_loan["remaining_months"], future_value = new_loan["future_value"], annual_discount_rate = .2
)
